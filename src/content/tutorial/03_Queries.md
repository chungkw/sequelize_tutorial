...
In [`seeder.js`](https://github.com/chungkw/sequelize_tutorial/tree/main/example/src/database/seeder.js):
...
In [`users.js`](https://github.com/chungkw/sequelize_tutorial/tree/main/example/src/controllers/users.js):
