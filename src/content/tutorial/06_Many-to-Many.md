...
Creating the new model, in [`Categories.js`](https://github.com/chungkw/sequelize_tutorial/tree/main/example/src/models/Categories.js):
...
As such, we also need another model to represent this table, in [`Categories.js`](https://github.com/chungkw/sequelize_tutorial/tree/main/example/src/models/Categories.js):
...
In [`games.js`](https://github.com/chungkw/sequelize_tutorial/tree/main/example/src/controllers/games.js):
