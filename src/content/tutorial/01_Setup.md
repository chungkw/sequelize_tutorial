...
In [`config.js`](https://github.com/chungkw/sequelize_tutorial/tree/main/example/src/config/index.js):
...
In [`connection.js`](https://github.com/chungkw/sequelize_tutorial/tree/main/example/src/config/connection.js):
...
In [`index.js`](https://github.com/chungkw/sequelize_tutorial/tree/main/example/src/index.js):
